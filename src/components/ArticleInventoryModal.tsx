...
export const ArticleInventoryModal: React.FC<ArticleInventoryModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 border border-slate-200 dark:border-slate-800 rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150 flex flex-col max-h-[92vh]"
        onClick={(e) => e.stopPropagation()}
        role="dialog"
        aria-modal="true"
      >
        {/* Modal Header */}
        <div className="p-4 sm:p-5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50/80 dark:bg-slate-950/90">
          <div className="flex items-center gap-2.5">
            <span className="p-2 rounded-xl bg-red-50 dark:bg-red-950/60 text-red-600 dark:text-red-400 border border-red-200/50 dark:border-red-900/50">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-xs font-bold px-2 py-0.5 rounded-md bg-slate-200 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border border-slate-300/50 dark:border-slate-700">
                  {article.codeArticle}
                </span>
              </div>
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4 bg-white dark:bg-slate-900">
          ...
          <div className="bg-slate-50 dark:bg-slate-950/80 rounded-xl p-3 border border-slate-200 dark:border-slate-800 space-y-2.5">
            <div className="flex items-center justify-between text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
              ...
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-300/50 dark:border-slate-700">
                Lecture Seule
              </span>
            </div>

            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs">
              <div className="bg-white dark:bg-slate-900 p-2.5 rounded-lg border border-slate-200/80 dark:border-slate-800 shadow-2xs">
                <div className="text-[10px] text-slate-400 uppercase font-semibold">Code Article</div>
                <div className="font-mono font-bold text-slate-900 dark:text-white truncate mt-0.5">
                  {article.codeArticle}
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 p-2.5 rounded-lg border border-slate-200/80 dark:border-slate-800 shadow-2xs">
                ...
                <div className="font-mono font-black text-slate-900 dark:text-white text-sm text-center mt-0.5">
                  {article.qteSap} {article.unite || 'U'}
                </div>
              </div>

              <div className="col-span-2 sm:col-span-1 bg-white dark:bg-slate-900 p-2.5 rounded-lg border border-slate-200/80 dark:border-slate-800 shadow-2xs">
                <div className="text-[10px] text-slate-400 uppercase font-semibold">Emplacement</div>
                <div className="font-bold text-slate-800 dark:text-slate-200 truncate flex items-center gap-1 mt-0.5">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-12 sm:w-14 h-12 sm:h-14 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 active:bg-slate-300 dark:active:bg-slate-750 text-slate-800 dark:text-white font-bold flex items-center justify-center border border-slate-300 dark:border-slate-700 text-lg shadow-xs transition active:scale-95 shrink-0 cursor-pointer"
                >
                ...
                <div className="relative flex-1">
                  <input
                    ...
                    placeholder="0"
                    className="w-full h-12 sm:h-14 px-3 text-center text-3xl font-mono font-black rounded-xl border-2 border-red-600 focus:ring-4 focus:ring-red-600/30 outline-none text-slate-950 dark:text-white bg-white dark:bg-slate-950 shadow-inner"
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-slate-400 dark:text-slate-500 pointer-events-none hidden sm:inline">
                    {article.unite || 'PCS'}
                  </span>
                </div>
              ...
              <div className="grid grid-cols-4 gap-1.5 pt-0.5">
                <button
                  ...
                  className="h-9 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs border border-slate-200 dark:border-slate-700 transition active:scale-95 cursor-pointer"
                >
                  -5
                </button>
                <button
                ...
                <button
                  ...
                  className="h-9 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-emerald-50 dark:hover:bg-emerald-950/60 text-slate-700 dark:text-slate-200 hover:text-emerald-700 dark:hover:text-emerald-300 font-bold text-xs border border-slate-200 dark:border-slate-700 transition active:scale-95 flex items-center justify-center gap-1 cursor-pointer"
                ...
                <button
                  ...
                  className="h-9 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-rose-100 dark:hover:bg-rose-950/60 text-slate-600 dark:text-slate-300 hover:text-rose-800 dark:hover:text-rose-300 font-bold text-xs border border-slate-200 dark:border-slate-700 transition active:scale-95 flex items-center justify-center gap-1 cursor-pointer"
                >
            ...
            <div>
              <input
                ...
                className="w-full px-3 py-2.5 text-xs rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 focus:bg-white dark:focus:bg-slate-950 focus:border-red-600 dark:focus:border-red-500 outline-none text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 min-h-[38px]"
              />
            </div>
            ...
            <div className="pt-2 flex items-center justify-end gap-2.5">
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs hover:bg-slate-100 dark:hover:bg-slate-800 dark:hover:text-white transition cursor-pointer min-h-[44px]"
              >
                Annuler
              </button>
